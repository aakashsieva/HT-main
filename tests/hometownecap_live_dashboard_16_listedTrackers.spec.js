...
test('View Listed Trackers', async ({ page }) => {
  ...
  // Unit column
  await page.locator('.secListAllDevices #tbldevicesTable th:has-text("Name")').click();
  await page.waitForTimeout(2000);
  await page.locator('.secListAllDevices #tbldevicesTable th:has-text("Name")').click();
  await page.waitForTimeout(2000);

  // Last Activity column
  await page.locator('.secListAllDevices #tbldevicesTable th:has-text("IMEI")').click();
  await page.waitForTimeout(2000);
  await page.locator('.secListAllDevices #tbldevicesTable th:has-text("IMEI")').click();
  await page.waitForTimeout(2000);

  // Location column
  await page.locator('.secListAllDevices #tbldevicesTable th:has-text("Device Type")').click();
  await page.waitForTimeout(2000);
  await page.locator('.secListAllDevices #tbldevicesTable th:has-text("Device Type")').click();
  await page.waitForTimeout(2000);
