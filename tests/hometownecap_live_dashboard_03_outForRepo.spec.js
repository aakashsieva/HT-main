 ...
 */
  ...
  // Details column
  await page.locator('.secOutForRepoOrInAgg #tblDeviceRepoOrInAggReport th:has-text("Details")').click();
  await page.waitForTimeout(2000);
  await page.locator('.secOutForRepoOrInAgg #tblDeviceRepoOrInAggReport th:has-text("Details")').click();
  await page.waitForTimeout(2000);
  ...
  */
  ...
  await searchInput.fill('868996064379803');
  ...
  const exportButtons = page.locator('.secOutForRepoOrInAgg a.buttons-excel, .secOutForRepoOrInAgg a.buttons-pdf, .secOutForRepoOrInAgg a.buttons-csv');
